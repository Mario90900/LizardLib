...
//Code for this class given by Pahimar of EE3, was given permission to use his open source EE3 code during his Youtube series "Lets Mod Reboot".
//Updated for use with 1.8 by myself, with added documentation.
public class NBTHelper {
	/**
	 * Checks for a given NBT Tag on given ItemStack
	 * 
	 * @param itemStack
	 * @param keyName
	...
	/**
	 * Removes a given NBT Tag on given ItemStack
	 * 
	 * @param itemStack
	 * @param keyName
	 */
